...
- `greet_mmgxhaa6(name: string | null | undefined): string` — returns `"Hello, {name}!"`, throws `Error('Name cannot be empty')` for null/undefined/empty input (in `src/greet_mmgxhaa6.ts`)
