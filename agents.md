...
- `greet_mmgvbzws(name: string | null | undefined): string` — returns `"Hello, {name}!"`, throws `Error('Name cannot be empty')` for null/undefined/empty/whitespace input (in `src/greet_mmgvbzws.ts`)
