...
- `subtract_*(a: number, b: number): number` — subtraction (multiple variants, includes `subtract_fyizk`, `subtract_bwv2l_c`, `subtract_wt6vj`, `subtract_nuogg`, `subtract_p5ru9_c`, `subtract_pn2q5_c`)
