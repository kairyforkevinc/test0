...
## Project Structure
```
src/           — 32 source files (greet, greet_i228, greet_i231, add_*, subtract_*, multiply_*, divide_*, math_*)
tests/         — 32 test files (1:1 mapping with src/)
...
- Unique suffix per module (e.g., `_wxcvj`, `_i231`)
