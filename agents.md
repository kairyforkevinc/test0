...
- `calculate_*(a: number, b: number): number` — math operations via `math_*.ts` modules (includes `calculate_fwakg`, `calculate_3yck5`)
- `multiply_3yck5(a: number, b: number): number` — multiplication via `math_3yck5.ts`
