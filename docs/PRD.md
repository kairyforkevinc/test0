...
- `subtract_wt6vj(a, b)` — issue #368 (parent #366)
- `multiply_wt6vj(a, b)` — issue #369 (parent #366)
- `divide_wt6vj(a, b)` — issue #372 (parent #366)
- `subtract_bwv2l_c(a, b)` — issue #378
- `greet_ebk2v(name)` — issue #350
- `greet_juqtv(name)` — issue #359
